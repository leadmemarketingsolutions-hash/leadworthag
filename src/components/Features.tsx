      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            LeadWorthy Marketing works across phone, SMS, WhatsApp, and web chat — built for real-world trade businesses.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Button size="lg" className="btn-primary-gradient rounded-full px-8 h-12" asChild>
            <a href="#cta">Launch Your LeadWorthy Marketing Assistant</a>
          </Button>
